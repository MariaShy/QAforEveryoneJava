...
public abstract class EmployeeHelper {
    ...
    //поиск сотрудника в массиве по его имени
    static IEmployee searchByName(IEmployee[] emp, String name){
    ...
    //поиск сотрудника в массиве по вхождению указанной строки в его имени
    static IEmployee searchBySubName(IEmployee[] emp, String subName){
        for (int i=0; i<emp.length; i++){
    ...
    //подсчет зарплатного бюджета для всех сотрудников в массиве
    static double getSalaryBudget(IEmployee[] emp){
        double budget=0;
        for (int i=0; i<emp.length; i++){
    ...
    //поиск наименьшей зарплаты в массиве
    static double getMinSalary(IEmployee[] emp){
    ...
    //поиск наибольшей зарплаты в массиве
    static double getMaxSalary(IEmployee[] emp){
        double maxSalary=0;
        for (int i=0; i<emp.length; i++){
